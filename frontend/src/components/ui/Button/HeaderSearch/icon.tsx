    ...
    >
        ...
        <defs>
            ...
            >
                <use
                    xlinkHref="#image0"
                    transform="matrix(0.017 0 0 0.02 0.075 0)"
                />
            </pattern>
            <image
                id="image0"
